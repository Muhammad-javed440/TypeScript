...
var favoriteFruits = ['apple', 'banana', 'orange', 'strawberry', 'kiwi'];
...
var favoriteFruits2 = ['watermelon', 'pineapple', 'peach'];
...
for (var i = 0; i < favoriteFruits2.length; i++) {
    if (favoriteFruits2[i] === 'watermelon') {
        console.log("You really like ".concat(favoriteFruits2[i], "!"));
    }
    else {
        console.log("".concat(favoriteFruits2[i].toLowerCase(), " is in your list."));
    }
}
